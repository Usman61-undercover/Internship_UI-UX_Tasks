...
| :--- | :--- | :--- | :--- |
| **Primary** | Brand | `#E8541A` | Main CTAs (Sign In, Post) |
| | Brand Light | `#FFF0EA` | Secondary backgrounds |
| | Brand Dark | `#B83D0E` | Hover/Pressed states |
| **Neutral** | Text Primary | `#1A1A1A` | Main headings |
| | Text Secondary| `#555555` | Body/Sub-text |
| | Placeholder | `#999999` | Form hints |
| | Background | `#F8F7F5` | Main page body |
| | Border | `#E0DDD8` | Input/Divider lines |
| **Semantic** | Photo/Video | `#4CAF50` | Post creation icons |
| | Tag Friends | `#2196F3` | Post creation icons |
| | Feeling | `#FFC107` | Post creation icons |

### Typography
* **Font Family:** SF Pro Display (Headings), SF Pro Text / Roboto (Body).
* **Scale:**
...
* **Bottom Nav:** Featuring a 48px FAB (+) center button in Brand Orange.
...
* **Visual Cues:** Toggle switches use both color and position to indicate state.
